  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col md:flex-row relative overflow-x-hidden text-slate-300 bg-brand-dark">
        ...
        {/* Navegación Lateral */}
        <nav className="w-full md:w-72 backdrop-blur-xl bg-[#141A28]/70 border-r border-slate-800 flex flex-col shadow-2xl md:min-h-screen shrink-0 relative z-10">
        ...
        {/* Contenido Principal */}
        <main className="flex-1 p-6 md:p-12 max-w-6xl mx-auto w-full overflow-y-auto relative z-10">
