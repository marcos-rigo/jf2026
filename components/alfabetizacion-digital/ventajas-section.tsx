    ...
    <section id="ventajas" className="scroll-mt-28 md:scroll-mt-32 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-6 md:p-8 rounded-3xl bg-gradient-to-br from-white via-emerald-50/30 to-teal-50/20 border border-emerald-200/80 shadow-md shadow-slate-100 hover:shadow-xl hover:border-emerald-400 transition-all space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-3xl font-black font-mono text-emerald-600">+1.9% PIB</span>
          </div>

          <div>
            <h3 className="text-lg font-bold text-slate-900 font-display">Impacto en Crecimiento Macroeconómico</h3>
            <p className="text-xs text-emerald-800 font-mono font-semibold mt-0.5">Por cada +10% de aumento en penetración de banda ancha fija</p>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-white/90 border border-emerald-200/60 shadow-sm space-y-2">
            <p className="text-xs italic text-slate-700 leading-relaxed">&ldquo;{PIB_QUOTE.text}&rdquo;</p>
            <SourceCite source={PIB_QUOTE.source} />
          </div>
        </div>

        {/* Escudo Salarial ante IA y Mercado Laboral */}
        <div className="p-6 md:p-8 rounded-3xl bg-gradient-to-br from-white via-sky-50/40 to-blue-50/20 border border-sky-200/80 shadow-md shadow-slate-100 hover:shadow-xl hover:border-sky-400 transition-all space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-3xl font-black font-mono text-sky-600">80% Middle-Skill</span>
          </div>

          <div>
            <h3 className="text-lg font-bold text-slate-900 font-display">Escudo Salarial y Resiliencia ante la IA</h3>
            <p className="text-xs text-sky-800 font-mono font-semibold mt-0.5">Índice multidimensional Di (Entropy-TOPSIS)</p>
          </div>

          <p className="text-sm text-slate-700 leading-relaxed font-sans">
            El <strong className="text-slate-900 font-semibold">80% de las vacantes en empleos de cualificación media</strong> exigen competencias digitales. Ante la automatización del <strong className="text-sky-700 font-semibold">44% de las tareas laborales</strong> en América Latina, el índice de alfabetización digital ($D_i$) funciona como la mayor protección salarial.
          </p>

          <div className="p-4 rounded-2xl bg-white/90 border border-sky-200/60 shadow-sm space-y-2">
            <p className="text-xs italic text-slate-700 leading-relaxed">&ldquo;{MERCADO_LABORAL_QUOTE.text}&rdquo;</p>
      ...
      <div className="p-6 md:p-7 rounded-3xl bg-white border border-slate-200/80 shadow-md shadow-slate-100 space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-base font-bold text-slate-900 font-display">Autonomía Cívica y Transparencia Pública</h3>
            <p className="text-xs text-slate-500 font-mono">Ejercicio de derechos en la era algorítmica</p>
          </div>
        </div>
