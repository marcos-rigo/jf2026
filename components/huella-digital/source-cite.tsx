...
import type { Source } from '@/lib/huella-digital-content';
...
// components/ciudadania-digital/source-cite.tsx, pero con paleta clara para
// calzar con el tema visual de esta página (slate/blanco/azul, no el cyberpunk oscuro).
  ...
  if (source.url) {
    return (
      <a
        ...
        className={`${base} hover:text-blue-600 transition-colors ${className}`}
      >
        {content}
